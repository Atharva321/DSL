...
public class Clientfinal {     public static 
...
int port = 6789; //port numbrt  
 ...
 // Try to open input and output streams  
        ...
        try {  
            ...
            os = new DataOutputStream(clientSocket.getOutputStream());//output stream of client 
socket  
...
from terminal  
  String keyboardInput = br.readLine();//storing input in keyboard   os.writeBytes( 
keyboardInput + "\n" );//writing keyboard into input stream buffer of server  
  
  int n = Integer.parseInt( keyboardInput );   if ( n == 0 || 
n == -1 ) {//condiition to get out from loop  
      break;  
  }  
